...
function sc_bp_change_user_nav() {
    buddypress()->members->nav->edit_nav(array('position' => 0), 'activity');
    buddypress()->members->nav->edit_nav(array('position' => 10), 'profile');
    buddypress()->members->nav->edit_nav(array('position' => 20), 'groups');
    buddypress()->members->nav->edit_nav(array('position' => 30), 'friends');
    buddypress()->members->nav->edit_nav(array('position' => 40), 'notifications');
    buddypress()->members->nav->edit_nav(array('position' => 50), 'messages');
    buddypress()->members->nav->edit_nav(array('position' => 60), 'settings');
}

add_action('bp_setup_nav', 'sc_bp_change_user_nav', 100);