...
function sc_script_style(){
    ...
    // endif;
    wp_enqueue_style('sc-app-style', get_template_directory_uri().'/asset/css/app.min.css', array(), '1.6');
...
add_image_size('blog', 2000, 9999, array('center', 'center'));
add_image_size('blog-single', 2000, 9999, array('center', 'center'));
...
function sc_register_menus(){
    register_nav_menus(array(
        'primary'             => __('Primary', 'centro'),
        'secondary'           => __('Secondary', 'centro'),
        'categories'          => __('Categories', 'centro')
    ));
}
