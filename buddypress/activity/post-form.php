    ...
    <div id="whats-new-container">
        ...
        <div id="whats-new-content">
            <div id="whats-new-textarea">
                ...
                <?php endif; ?>
                 name="whats-new" id="whats-new" cols="50" rows="10"<?php if(bp_is_group()) : ?> data-suggestions-group-id="<?php echo esc_attr((int) bp_get_current_group_id()); ?>" <?php endif; ?>><?php if(isset($_GET['m'])) : ?>@<?php echo esc_textarea($_GET['m']); ?> <?php endif; ?></textarea>
            </div><!-- TEXTAREA -->
