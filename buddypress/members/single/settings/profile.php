...
<div class="info">
	<p>Chose which fields appear to other members of this site.</p>
</div>

<form action="<?php echo trailingslashit( bp_displayed_user_domain() . bp_get_settings_slug() . '/profile' ); ?>" method="post" class="standardise" id="settings-form">
<fieldset>
