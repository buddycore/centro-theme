	...
	<div class="notifications">
			...
			<?php while(bp_the_notifications()) : bp_the_notification(); ?>
				...
				<article class="notification">
					...
					<ul class="options">
						<li class="select"><label for="<?php bp_the_notification_id(); ?>"><input id="<?php bp_the_notification_id(); ?>" type="checkbox" name="notifications[]" value="<?php bp_the_notification_id(); ?>" class="notification-check"><span class="bp-screen-reader-text"><?php _e('Select', 'buddypress'); ?></span></label></li>
